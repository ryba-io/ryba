...
com.sun.management.jmxremote.ssl.config.file=<file>.
      ...
      options.jmx_config_file ?= "#{service.deps.hdfs_jn.options.conf_dir}/jmx.properties"
      service.deps.hdfs_jn.options.opts.java_properties['com.sun.management.config.file'] ?= options.jmx_config_file
      options.jmx_config ?= {}
      options.jmx_config['com.sun.management.jmxremote'] ?= 'true'
      options.jmx_config['com.sun.management.jmxremote.port'] ?= '9013'
      options.jmx_config['com.sun.management.jmxremote.ssl.config.file'] ?= "#{service.deps.hdfs_jn.options.conf_dir}/jmx-ssl.properties"
...
## Enable JMX SSL
      ...
      if !!options.ssl
        ...
        service.deps.hdfs_jn.options.opts.java_properties['com.sun.management.jmxremote.ssl'] ?= 'true'
        service.deps.hdfs_jn.options.opts.java_properties['com.sun.management.jmxremote.ssl.need.client.auth'] ?= 'false'
