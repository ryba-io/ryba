...
com.sun.management.jmxremote.ssl.config.file=<file>.
      ...
      options.jmx_config_file ?= "#{service.deps.yarn_rm.options.conf_dir}/jmx.properties"
      ...
      options.jmx_config['com.sun.management.jmxremote.ssl.config.file'] ?= "#{service.deps.yarn_rm.options.conf_dir}/jmx-ssl.properties"
